...
const FlexboxExample = () => {
  const [imageSource, setImageSource] = useState(require('./src/assets/icon3.png'));
  // Fungsi untuk mengganti gambar
  const toggleImage = () => {
    const nextImage = imageSource === require('./src/assets/icon3.png')
      ? require('./src/assets/icon4.png')
      : require('./src/assets/icon3.png');
        ...
        <ScrollView>
          ...
          <View style={styles.contentImage}>
            <View style={styles.gambar1}>
              <Image
                source={require('./src/assets/gambar1.png')} />
            </View>
            <View style={styles.deskripsi}>
              ...
              <Text style={styles.ProducerContent}>Nina Jacobson, Francis-
                Lawrence, Brad Simpson</Text>
              <Text style={styles.Writer}>Writer:</Text>
              <Text style={styles.WriterContent}>Nina Jacobson, Francis-
                Lawrence, Brad Simpson</Text>
          ...
          <View style={styles.sipnopsis}>
            ...
            <Text style={styles.isiCerita}>When Earth becomes uninhabitable in the  future, a farmer and ex-NASA
              pilot,  Joseph Cooper, is tasked to pilot a spacecraft, along with a team of
              researchers, to find a new planet for humans.</Text>
            <Text style={styles.koleksi}>Jadikan Koleksi</Text>
            <View style={styles.favorit}>
              <TouchableOpacity onPress={toggleImage}>
                <Image source={imageSource} style={styles.icon3} />
              </TouchableOpacity>
